       ...
       <div class="z-10">
           <div class="w-56 h-64 text-center bg-orange-500 rounded-lg">
                <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
                    ...
                    <table class="grid grid-cols-2 gap-4">
                        <td class="form-group mb-6">
                        ...
                        <td type="text" class="form-control block
                            w-full
                            px-3
                            py-1.5
                            text-base
                        ...
                        <div class="form-group mb-6">
                            <td class="block text-gray-700 text-sm font-bold mb-2 dark:text-dark" for="username">
                                TANGGAL LAHIR
                            </td>
                            <td date-rangepicker class="flex items-center">
                                <div class="relative">
                                    <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
                                    </div>
                                    <td name="date" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        {{ $data['tanggal-lahir'] }}
                                    </td>
                                </div>
                            </td>
